...
import com.pedrolsoares.hql.service.ActorService;
...
public class ActorController {
    ...
    public ResponseEntity<List<Actor>> listAllWithFavoriteMovie(){
        List<Actor> actorList = actorService.listAllWithAssignedFavoriteMovie();
